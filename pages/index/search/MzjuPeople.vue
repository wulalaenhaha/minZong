	...
	export default {
		...
		methods:{
			...
			select_cun(cunID){
				...
				this.getPeoples(this.quId,this.cunID,0)
			},
			
			getPeoples(quId,cunID,CardId){     
				//id  为村  ID
				console.log(CardId,this.quId)
				var _this=this;
			...
			search(){            //搜索按钮
				...
				this.PageNum=0
				this.getPeoples(this.quId,this.cunID,this.carId)
